<template>
  <router-link
    ...
    :class="{ 'border-green-400': journal.writing_phase === 'completed' }"
  >
    <!-- Image Placeholder -->
    ...
    <div class="flex-grow overflow-hidden">
      <div class="flex items-center gap-2">
        ...
        <div v-if="journal.writing_phase === 'completed'" class="flex-shrink-0 bg-green-100 text-green-700 text-xs font-bold px-2 py-0.5 rounded-full">
          Completed
        </div>
      </div>
