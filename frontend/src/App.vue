    ...
    <header v-if="!isWriterView" class="flex justify-between items-center mb-6 flex-shrink-0">
      <div class="flex items-center gap-3">
         ...
         <nav class="flex items-center gap-4">
           <router-link to="/learning-hub" class="text-sm font-semibold text-gray-600 hover:text-indigo-600 dark:text-gray-300 dark:hover:text-indigo-400 transition-colors hidden sm:block">Learning Hub</router-link>
